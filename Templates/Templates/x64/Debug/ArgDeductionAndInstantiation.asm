...
__8A222619_ArgDeductionAndInstantiation@cpp DB 01H
...
PUBLIC	??$Max@PEBD@@YAPEBDPEBD0@Z			; Max<char const *>
...
PUBLIC	??$sum@H$03@@YAHAEAY03H@Z			; sum<int,4>
...
PUBLIC	??_C@_06OKBBGPCH@strcmp@			; `string'
PUBLIC	??_C@_01FHEEJDEE@A@				; `string'
PUBLIC	??_C@_01HMGJMAIH@B@				; `string'
PUBLIC	??_C@_06JMFLDIOG@sum?5?$DN?5@			; `string'
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$??$Max@D@@YADDD@Z DD imagerel $LN5
	DD	imagerel $LN5+142
	DD	imagerel $unwind$??$Max@D@@YADDD@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$??$Max@PEBD@@YAPEBDPEBD0@Z DD imagerel $LN5
	DD	imagerel $LN5+141
	DD	imagerel $unwind$??$Max@PEBD@@YAPEBDPEBD0@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$??$Max@H@@YAHHH@Z DD imagerel $LN5
	DD	imagerel $LN5+135
	DD	imagerel $unwind$??$Max@H@@YAHHH@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$??$Max@N@@YANNN@Z DD imagerel $LN5
	DD	imagerel $LN5+153
	DD	imagerel $unwind$??$Max@N@@YANNN@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$??$sum@H$03@@YAHAEAY03H@Z DD imagerel $LN6
	DD	imagerel $LN6+136
	DD	imagerel $unwind$??$sum@H$03@@YAHAEAY03H@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT ??_R0N@8
data$r	SEGMENT
??_R0N@8 DQ	FLAT:??_7type_info@@6B@			; double `RTTI Type Descriptor'
...
;	COMDAT ??_R0D@8
data$r	SEGMENT
??_R0D@8 DQ	FLAT:??_7type_info@@6B@			; char `RTTI Type Descriptor'
	DQ	0000000000000000H
	DB	'.D', 00H
data$r	ENDS
;	COMDAT ??_C@_06JMFLDIOG@sum?5?$DN?5@
CONST	SEGMENT
??_C@_06JMFLDIOG@sum?5?$DN?5@ DB 'sum = ', 00H		; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_06OKBBGPCH@strcmp@
CONST	SEGMENT
??_C@_06OKBBGPCH@strcmp@ DB 'strcmp', 00H		; `string'
CONST	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??$sum@H$03@@YAHAEAY03H@Z DD 025051301H
	DD	010e2313H
	DD	070070031H
	DD	05006H
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$??$Max@N@@YANNN@Z DD 035051a01H
	DD	0115331aH
	DD	0700e0021H
	DD	0500dH
xdata	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??$Max@H@@YAHHH@Z DD 025051601H
	DD	01112316H
	DD	0700a001fH
	DD	05009H
xdata	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??$Max@PEBD@@YAPEBDPEBD0@Z DD 025051801H
	DD	01132318H
	DD	0700c001fH
	DD	0500bH
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$??$Max@D@@YADDD@Z DD 025051601H
	DD	01112316H
	DD	0700a001fH
	DD	05009H
xdata	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\320112313\source\repos\ModernCpp\Templates\Templates\ArgDeductionAndInstantiation.cpp
;	COMDAT ??$sum@H$03@@YAHAEAY03H@Z
_TEXT	SEGMENT
sum$ = 4
<range>$L0$1 = 40
<begin>$L0$2 = 72
...
x$4 = 132
a$ = 384
??$sum@H$03@@YAHAEAY03H@Z PROC				; sum<int,4>, COMDAT
...
$LN6:
	...
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__8A222619_ArgDeductionAndInstantiation@cpp
	call	__CheckForDebuggerJustMyCode
...
; 36   : }
	...
	pop	rbp
	ret	0
??$sum@H$03@@YAHAEAY03H@Z ENDP				; sum<int,4>
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\320112313\source\repos\ModernCpp\Templates\Templates\ArgDeductionAndInstantiation.cpp
...
; 40   : 	std::cout << Max(1, 2) << endl;//1.func template invoked
...
; 41   : 	 //compiler calculates the template type by argument deduction
; 42   : 	 //we can override arg deduction by explicitely mentioning
; 43   : 	cout << Max<double>(1, 2.3) << endl;

	movsd	xmm1, QWORD PTR __real@4002666666666666
...
; 44   : 	int (*ptr)(int, int) = Max;//2.taking address of func template)invoked

	lea	rax, OFFSET FLAT:??$Max@H@@YAHHH@Z	; Max<int>
	mov	QWORD PTR ptr$[rbp], rax

; 45   : 	std::cout << Max('1', '2') << endl;

	mov	dl, 50					; 00000032H
	mov	cl, 49					; 00000031H
	call	??$Max@D@@YADDD@Z			; Max<char>
	movzx	edx, al
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
...
; 49   : 	cout << Max(a, b);
	...
	call	??$Max@PEBD@@YAPEBDPEBD0@Z		; Max<char const *>
	mov	rdx, rax
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >

; 50   : 
; 51   : 	//non type template argument
; 52   : 	int arr[] = { 1,2,3,4 };

	mov	DWORD PTR arr$[rbp], 1
	mov	DWORD PTR arr$[rbp+4], 2
	mov	DWORD PTR arr$[rbp+8], 3
	mov	DWORD PTR arr$[rbp+12], 4

; 53   : 	int(&ref)[4] = arr;// here for creating reference to array we sould explicitly mention the size, which can't have different value than size

	lea	rax, QWORD PTR arr$[rbp]
	mov	QWORD PTR ref$[rbp], rax

; 54   : 	cout << "sum = " << sum(arr) << endl;

	lea	rcx, QWORD PTR arr$[rbp]
	call	??$sum@H$03@@YAHAEAY03H@Z		; sum<int,4>
	mov	DWORD PTR tv130[rbp], eax
	lea	rdx, OFFSET FLAT:??_C@_06JMFLDIOG@sum?5?$DN?5@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\320112313\source\repos\ModernCpp\Templates\Templates\ArgDeductionAndInstantiation.cpp
;	COMDAT ??$Max@PEBD@@YAPEBDPEBD0@Z
_TEXT	SEGMENT
tv73 = 192
a$ = 240
b$ = 248
??$Max@PEBD@@YAPEBDPEBD0@Z PROC				; Max<char const *>, COMDAT
...
; 21   : 	cout << "strcmp" << endl;
	...
	lea	rdx, OFFSET FLAT:??_C@_06OKBBGPCH@strcmp@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
	lea	rdx, OFFSET FLAT:??$endl@DU?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	rcx, rax
...
; 23   : }
	...
	pop	rbp
	ret	0
??$Max@PEBD@@YAPEBDPEBD0@Z ENDP				; Max<char const *>
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\320112313\source\repos\ModernCpp\Templates\Templates\ArgDeductionAndInstantiation.cpp
...
$LN3:
	...
	sub	rsp, 232				; 000000e8H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__3FA95DB0_vcruntime_typeinfo@h
	call	__CheckForDebuggerJustMyCode
